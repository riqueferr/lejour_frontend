...
import GraphOne from './ChartInvoicesMar';
        ...
        <div className="big-little-box">
            ...
            <div className="data-box">
                ...
                <div class="months">
                        ...
                        <li className="custom-select"><a href="/invoiceMar">mar</a></li>
